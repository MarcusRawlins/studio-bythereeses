...
>
> CRM source-of-truth SOP: `docs/crm-source-of-truth-sop.md`. Use `/Volumes/reeseai-memory/code/reese-photography-crm` as the canonical working copy and run `npm run check:source-drift` before durable code, branch, or deploy work.
>
