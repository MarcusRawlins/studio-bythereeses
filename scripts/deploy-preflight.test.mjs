...
assert.deepEqual(blocked.errors, [
  ...
  "src/middleware.ts is required so the origin guard deploys as Edge middleware.",
  "src/proxy.ts is present; OpenNext Cloudflare currently rejects Next.js Node proxy middleware.",
]);
