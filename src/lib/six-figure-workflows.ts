...
export const sixFigureWorkflowTemplates: SixFigureWorkflowTemplate[] = [
  ...
  {
    id: "six-figure-workflow-post-delivery",
    type: "workflow",
    name: "Studio: Post-wedding delivery, review, and referral",
    trigger: "After wedding day or session coverage",
    subject: "Delivery through review and referral follow-up",
    body: [
      "Post-event delivery sequence adapted for The Reeses Studio. Drafts only — Tyler approves and sends.",
      "",
      "1. Send day-after card or message celebrating the event.",
      "2. Deliver sneak peek with gallery link and next-step expectations.",
      "3. Deliver full gallery with access and download/print guidance.",
      "4. Ask for a review at the right emotional moment.",
      "5. Follow up with a personal referral ask when appropriate.",
      "6. Queue anniversary touchpoint separately when the date arrives.",
    ].join("\n"),
    status: "active",
  },
  {
  ...
  {
    id: "six-figure-workflow-referral-follow-up-email",
    type: "email",
    name: "Studio: Referral follow-up email outline",
    trigger: "After review or strong positive delivery moment",
    subject: "Know anyone planning a wedding?",
    body: [
      "Adapted referral follow-up outline for The Reeses Studio.",
      "",
      "Thank the client again for the kind words or great experience, explain briefly how referrals help future couples find the right photographer, and ask if they know anyone currently planning a wedding or session. Keep it personal, specific, and low-pressure.",
    ].join("\n"),
    status: "active",
  },
  {
