...
const obsidianPaths = [
  {
    label: 'System rules',
    path: '03 Content Systems/TikTok System.md',
    detail: 'Platform-specific rules, script norms, and repurposing guidance.',
  },
  {
    label: 'Canonical field model',
    path: '03 Content Systems/Short-Form Content Tracker.md',
    detail: 'Shared field definitions and sync rules for the dashboard.',
  },
  {
    label: 'Business tracker',
    path: '02 Businesses/The Reeses/Short-Form Tracker.md',
    detail: 'Operational overview for TikTok, Reels, Stories, and feed posts.',
  },
  {
    label: 'Per-item notes',
    path: '07 Active Projects/Content Items/The Reeses/<date - title>.md',
    detail: 'Only for high-performing, reusable, or multi-platform pieces.',
  },
]
    ...
    <main className="studio-shell">
      <section className="command-surface">
        <div className="hero-copy">
          ...
          <p className="lead">
            April is seeded from the calendar plan and mapped to the same structure already living in Obsidian.
            This makes the site an execution dashboard instead of a second source of truth.
          </p>
        </div>
      ...
      <section className="metrics-grid">
        ...
        <MetricCard
          ...
          detail="TikTok, Reels, and feed posts are balanced without hiding Stories."
        />
      </section>
