...
const studioTools = [
  ...
  },
  {
    ...
    description: "Create a canonical invoice and payment schedule on a Studio project, optionally from a proposal.",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string", description: "Canonical Studio project id." },
  ...
  },
  {
    ...
    description: "Revise an existing unpaid canonical Studio invoice, including total, payment schedule, accepted payment methods, and fee passthrough snapshot.",
    inputSchema: {
      type: "object",
      properties: {
        projectId: { type: "string", description: "Canonical Studio project id." },
  ...
  },
  {
    ...
    description: "Record a canonical invoice payment in the Studio payment ledger from trusted agent payment or receipt intake.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description: "Correct an existing canonical invoice payment ledger row from trusted agent receipt, processor, or bookkeeping reconciliation.",
    inputSchema: {
      type: "object",
      properties: {
        invoiceId: { type: "string", description: "Canonical Studio invoice id." },
  ...
  },
  {
    ...
    description: "Record canonical payment status for a paid scheduler booking from trusted agent checkout or receipt intake.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description: "Correct an existing canonical scheduler booking payment row from trusted checkout, processor, or bookkeeping reconciliation.",
    inputSchema: {
      type: "object",
      properties: {
        bookingId: { type: "string", description: "Canonical Studio scheduler booking id." },
